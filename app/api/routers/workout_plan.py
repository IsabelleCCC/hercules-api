...
from core.schemas.workout_plan import WorkoutPlanCreate, WorkoutPlanUpdate, WorkoutPlan, WorkoutPlanCreated, WorkoutPlanWithExercisePlan
...
@WorkoutPlanRouter.get("/{workout_plan_id}", response_model=WorkoutPlanWithExercisePlan)
...
@WorkoutPlanRouter.get("", response_model=List[WorkoutPlanWithExercisePlan])
...
@WorkoutPlanRouter.post("", response_model=WorkoutPlanWithExercisePlan)
